<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmInventoryManagement.aspx.cs" Inherits="frmInventoryManagement" %>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="frmDatabaseManagement.aspx" class="page-scroll">Database Management System</a></li>
                    <li><a href="#tf-about,frmInventoryManagement.aspx" class="page-scroll">Inventory Management System</a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
    ...
    <div id="tf-about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="img/inventory_management_c.jpg" class="img-responsive">
                </div>
                <div class="col-md-6">
                    <div class="about-text">
                        <div class="about-text">
                            <div class="section-title">
                                <h4>Inventory Softwares</h4>
                                <hr>
                                <div class="clearfix"></div>
                            </div>
                            <p class="intro">For making every second count worth for any Business. We have created an inventory softwares that track record of inward and outward of purchase and sales, and also keep that record for future backup. Also we are dealing in Billing softwares based upon the requirement of clients. </p>
