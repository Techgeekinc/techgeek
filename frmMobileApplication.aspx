<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMobileApplication.aspx.cs" Inherits="frmMobileApplication" %>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#tf-about,frmMobileApplication.aspx" class="page-scroll">Mobile Application</a></li>
    ...
    <div id="tf-about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="img/mobile_app_development_c.jpg" class="img-responsive">
                </div>
                <div class="col-md-6">
                    <div class="about-text">
                        <div class="section-title">
                            <h4>Mobile Appliction</h4>
                            <hr>
                            <div class="clearfix"></div>
                        </div>
                        <p class="intro">We at Techgeek develop customized Mobile Application by our specialized team. Using the platform of andriod, windows as well as apple. Majorly, our target area for mobile application are Hotel Industry, Appareal Industry, Jewelery, watches and many more. </p>
