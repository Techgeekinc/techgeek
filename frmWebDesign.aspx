<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmWebDesign.aspx.cs" Inherits="frmWebDesign" %>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#tf-about,frmWebDesign.aspx" class="page-scroll">Web Design</a></li>
    ...
    <div id="tf-about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
					<img src="img/Web_Design_c.jpg" class="img-responsive">
                </div>
                <div class="col-md-6">
                    <div class="about-text">
                        ...
                        <p class="intro">We at Techgeek making website by using the wellknown platform i.e html,css and bootstrap. We make dynamic, static website and also website link with mobile application. We provide customized application solution as per client's requirement   </p>
